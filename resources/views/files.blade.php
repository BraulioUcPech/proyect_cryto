    ...
    <header class="bg-white py-6 shadow-md">
        <div class="max-w-7xl mx-auto px-6 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-6">
                @auth
                <svg alt="{{ Auth::user()->name }} xmlns=" http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <img src={{Auth::user()->avatar}} alt="avatar" class="w-10" >
                ...
                <div class="w-1/4">
                    <nav class="p-5 bg-white rounded-lg shadow-md" id="navbar" class="hidden md:block ">
                        ...
                        <ul class="space-y-2">
                            ...
                            <li><a href="/deployments" class="block text-indigo-600 hover:underline">Deployments</a>
                            </li>
                            <li><a href="/my-settings" class="block text-indigo-600 hover:underline">My Settings</a>
                            </li>
                    ...
                    <div class="bg-white p-6 rounded-lg shadow-md">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="border rounded-lg p-4 flex flex-col items-center space-y-2 relative">
                                ...
                                @case('bmp')
                                @case('webp')
                                <img src="{{ $filePath }}" alt="Archivo" class="w-full h-32 object-cover rounded-md mb-2">
                                @break

                                @case('pdf')
                                <iframe src="{{ $filePath }}" class="w-full h-64"></iframe>
                                @break
                                ...
                                <h4 class="font-medium text-gray-900 text-sm truncate w-full text-center">{{
                                    $file->file_name }}</h4>
                ...
                <div class="relative top-20 mx-auto p-5 border w-3/4 shadow-lg rounded-md bg-white">
                    <div class="mt-3 text-center">
                        <div id="modal-content" class="mt-2">
                            <!-- Aquí irá el contenido del archivo seleccionado -->
...
@endif
                        ...
                        <div class="grid grid-cols-1 gap-8">
                            ...
                            <div>
                                ...
                                <ul class="mt-4 space-y-4">
                                    ...
                                    <li><a href="/privacy"
                                            class="text-base text-gray-500 hover:text-gray-900">Privacy</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{asset('js/script-files.js')}}"> </script>
